...
from handlers.zone_1.start import register_zone_1_handlers, process_zone_1_process
from handlers.zone_2.start import register_zone_2_handlers, process_zone_2_process
from handlers.zone_3.start import register_zone_3_handlers, process_zone_3_process
from handlers.zone_4.start import register_zone_4_handlers, process_zone_4_process
from handlers.zone_5.start import register_zone_5_handlers, process_zone_5_process
from handlers.zone_6.start import register_zone_6_handlers, process_zone_6_process
from handlers.zone_7.start import register_zone_7_handlers, process_zone_7_process
from handlers.zone_8.start import register_zone_8_handlers, process_zone_8_process
...
async def handle_zone_selection(message: Message):
    ...
    if text == "зона 1":
        ...
        await message.answer("Такой зоны ты не выбрал. Попробуй снова.")
