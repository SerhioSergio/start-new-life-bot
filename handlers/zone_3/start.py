...
async def handle_buttons(message: Message):
    ...
    if message.text == "Продолжить" and step < len(steps) - 1:
        ...
        save_user_step(user_id, "zone_3", 0)
        return
...
def register_zone_3_handlers(dp: Dispatcher):
    dp.register_message_handler(process_zone, lambda msg: msg.text.lower() == "зона 3")
